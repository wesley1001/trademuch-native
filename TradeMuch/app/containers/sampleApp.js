...
/**
 * A sample app that demonstrates use of the FBSDK login button ,
 * native share dialog, and graph requests.
 */
function Login() {
  return (
    <Image source={{ uri: 'plutoBack.png' }} style={styles.loginImage}>
